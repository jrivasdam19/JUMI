...
public class Profunditat {
    ...
    public static void construirMatriz_vector(int filas, int columnas, int profundidad) {
        matriz = new int[filas][columnas][profundidad];
        vector = new int[filas * columnas * profundidad];
    ...
    public static void actualizarValorMatriz_Vector(int f, int c, int p, int valor) {
        matriz[f][c][p] = valor;
        int posicionVector = matriz[0][0].length * matriz[0].length * f + matriz[0][0].length * c + p;
        vector[posicionVector] = valor;
    }

    public static void actualizarValorVector_Matriz(int p, int valor) {
        vector[p] = valor;
        int fila = (int) Math.floor(p / (matriz[0].length * matriz[0][0].length));
        System.out.println("fila " + fila);
        int columna = (int)Math.floor((p - matriz[0].length * matriz[0][0].length*fila)/matriz[0][0].length);
        System.out.println("columna " + columna);
        int profundidad = p - (matriz[0].length * matriz[0][0].length * fila) - (matriz[0][0].length * columna);
        ...
        while (!salir) {
            ...
            switch (opcion) {
                case 1:
                    ...
                    int profundidad = Integer.parseInt(lector.nextLine());
                    construirVector_matriz(filas, columnas, profundidad);
                    imprimir();
                    break;
                case 2:
                    System.out.println("Introduce las dimensiones de la matriz.");
                    ...
                    System.out.println("Profundidad");
                    profundidad = Integer.parseInt(lector.nextLine());
                    construirMatriz_vector(filas, columnas, profundidad);
                    imprimir();
                    break;
                case 3:
                    ...
                    actualizarValorMatriz_Vector(f, c, p, valorM);
                    imprimir();
                    break;
                case 4:
                    System.out.println("Introduce la posición.");
                    int posicion = Integer.parseInt(lector.nextLine());
                    System.out.println("Introduce un valor.");
                    int valorV = Integer.parseInt(lector.nextLine());
                    actualizarValorVector_Matriz(posicion, valorV);
                    imprimir();
                    break;
                case 5:
                    salir = true;
